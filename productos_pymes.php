...
<html><head>
    ...
    <body data-spy="scroll" data-target="#main-navbar">
        ...
        <div id="page" class="page">
                ...
                <nav class="navbar fixed-nav navbar-default  navbar-fixed-top" id="main-navbar" role="navigation">
                    <div class="container">
                        <div class="navbar-header">
                            ...
                            <a href="administrador_perfil.php" class="navbar-brand top-logo" style="outline: none; cursor: default;"><img src="images/app_block.jpg" alt="logo" style="outline: none; cursor: default;"></a>
                    ...
                    <ul class="nav navbar-nav navbar-left">
                        ...
                        <li class="nombre-perfil">
                            ...
                            <ul class="submenu-hijo" style="display:none;">
                             ...
                             <li><a href="productos_pymes.php">Productos</a></li>
            ...
            <?php include('modal/eliminar_empleado.php'); ?>
            <?php  include('modal/registro_producto.php'); ?>
            <?php include('modal/modificar_producto.php');?> 
            <?php include('modal/eliminar_producto.php');?> 
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-3">
                        <div class="feature wow fadeInLeft animated" data-wow-offset="120" data-wow-duration="1.5s">
                            <h4 style="outline: none; cursor: default;"></h4>
                            <p style="outline: none; cursor: default;">
                            </p>
                        </div>
                    </div><!--end 4 col-->

                    <?php include('page_part/productos.php'); ?>
                    <div class="col-sm-6 col-md-3">
